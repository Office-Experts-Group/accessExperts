...
const Testimonials = dynamic(() => import("../(components)/Services"));
...
const schema = {
  ...
  "@graph": [
    ...getAboutPageSchema(testimonials, "access")["@graph"],
    generateOrganizationSchema(),
    generateProfessionalServiceSchema(),
    generateWebSiteSchema(
    ...
    {
      "@type": "WebPage",
      "@id": "https://www.accessexperts.com.au/about-us",
      ...
      breadcrumb: {
        "@id": "https://www.accessexperts.com.au/about-us#breadcrumb",
      },
      inLanguage: "en-AU",
      potentialAction: [
        {
          "@type": "ReadAction",
          target: ["https://www.accessexperts.com.au/about-us"],
        },
      ],
    },
    {
