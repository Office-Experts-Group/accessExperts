      ...
      >
        <AnimateOnScroll animation="fade-up" duration={1} delay={0}>
          <div className={styles.content}>
            ...
            <p style={{ zIndex: "10" }}>
              Access Experts provides comprehensive Microsoft Access database
              ...
              timely, professional database services wherever you're located.
              Whether you need a quick consultation or full-scale database
              development, our Australia-wide team ensures you receive expert
              support with minimal travel costs and maximum efficiency.
            </p>
          </div>
        </AnimateOnScroll>
