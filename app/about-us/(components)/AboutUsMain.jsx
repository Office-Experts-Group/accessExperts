      ...
      <AnimateOnScroll animation="slide-right" delay={0} duration={1}>
        <div className={styles.content}>
          <div className={styles.underline}>
            <p>Your Access Specialists</p>
          </div>
          <h2>Access Database Development and Automation Australia</h2>
          <p className={styles.themeText}>
            For over 25 years, our experienced developers and consultants have
            specialised in Microsoft Access. Building robust and user-friendly
            database solutions for both Mac and PC users Australia-wide.
          </p>
          <div className={styles.text}>
            <p>
              What makes us different is our ability to combine deep technical
              expertise in database development with real-world business
              knowledge—allowing us to deliver efficient, scalable Microsoft
              Access solutions tailored to your unique operational needs.
            </p>
          </div>
